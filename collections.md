...
Configuration | Type | Default Value
------------- | ---- | ---------------
Report Name | text | WorldIndicators/GDPpercapita
Host URL | text | https://public.tableau.com
Site Root (empty if you are using public.tableau.com) | text | 
